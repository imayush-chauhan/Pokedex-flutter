                            ...
                            return Container(
                              ...
                              child: GestureDetector(
                                ...
                                child: Card(
                                  ...
                                  color:
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Electric" ? Colors.yellowAccent :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Fighting" ? Colors.blueGrey.withOpacity(0.8) :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Grass" ? Colors.greenAccent :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Water" ? Colors.blueAccent :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Poison" ? Colors.purpleAccent :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Rock" ? Colors.grey :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Ghost" ? Colors.deepPurple[300] :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Psychic" ? Colors.deepPurpleAccent :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Fire" ? Colors.orangeAccent:
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Ground" ? Colors.brown.withOpacity(0.8) :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Bug" ? Colors.greenAccent[700] :
                                  Data.poke["pokemon"][index]["typeofpokemon"][0] == "Dark" ? Colors.grey:
                                  Colors.white,
                                  child: Stack(
                                    children: [
                                      Positioned(
                                      ...
                                      Positioned(
                                        ...
                                        top: MediaQuery.of(context).size.height*0.04,
                                        left: 140,
                                        child: Text(Data.poke["pokemon"][index]["typeofpokemon"][0],
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.bold,
